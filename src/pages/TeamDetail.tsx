  ...
  return (
    <div className="flex items-center gap-3 py-2 border-b border-gold/10 last:border-0">
      ...
      <div className="flex items-center gap-2 shrink-0">
        ...
        {player.injuryStatus && (
          <span className="text-red-400 text-[10px] font-sans">{player.injuryStatus}</span>
        )}
      </div>
    </div>
  )
...
export default function TeamDetail() {
  ...
  return (
    <div>
      <Link to="/rosters" className="text-gold/70 text-xs font-sans hover:text-gold transition-colors mb-5 inline-flex items-center gap-1">
        ← All Rosters
      </Link>

      <div className="flex items-center gap-4 mb-8 pb-6 border-b border-gold/15">
